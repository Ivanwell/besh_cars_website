...
export const services = {
  sales: {
    ...
    prons: ['10 років досвіду', 'Власний автомайданчик', 'Перевірені авто'],
  ...
  select: {
    ...
    titleText: () => {
      return (
        <>
          <span className={styles.blue_font}>Підберемо</span> найкраще авто для
          Вас
        </>
      )
    },
  ...
  comision: {
    ...
    titleText: () => {
      return (
        <>
          <span className={styles.blue_font}>Продамо</span> Ваше авто без зайвих
          турбот
        </>
      )
    },
  ...
  trade: {
    ...
    prons: ['Обмін за 1 день', 'Ваша або наша доплата', 'Адекватна оцінка'],
    image: '/trade_in.jpg',
    revers: true,
  },
}
